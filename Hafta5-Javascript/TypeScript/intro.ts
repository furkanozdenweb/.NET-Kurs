...
console.log(" ------------------------------------------------------------------------------------");
function selamVer(GelenIsim:string,GelenSoyad:string){
    return "Merhaba "+ GelenIsim + " "+ GelenSoyad;
}

let Sunum = selamVer('Samet2 ','Erdem');  //Fonksiyon çağırma
console.log(Sunum); 
...
let sayi:number; //tipi sayı olan dizi tanımlanması
sayi=34342;
console.log(sayi);
...
console.log(" ------------------------------------------------------------------------------------");
let sayilar:number[] = [23,2,3,1,23];  //Tipi sadece sayısal ifadeler olabilen dizi tanımlanması.
console.log(sayilar);
...
console.log(" ------------------------------------------------------------------------------------");
let dizi:[number,string]=[12,"İstanbul"]; // Bir adet sayı ve bir adet metinsel ifadeden oluşan bir dizi oluşturur.
console.log(dizi);
...
//enum Değişken Tipi
console.log(" ------------------------------------------------------------------------------------");
enum Ayarlar {IpAdres="192.168.1.1",Tema="Dark",Surum="1.2"} // Typescript ile gelen en güzel veri tipi Enum - Süistimal edilmemeli. ! 
let ayarBilgisi=Ayarlar.IpAdres; // Ayarlar Enum'undaki IpAdres bilgisini çektik.
